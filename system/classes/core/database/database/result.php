 ...
 */
abstract class Core_Database_Database_Result implements Countable, Iterator, SeekableIterator, ArrayAccess {
    ...
    {
        throw new Core_Exception('Database results are read-only');
    }
