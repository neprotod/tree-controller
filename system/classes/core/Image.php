...
abstract class Core_Image {
    ...
    public function __construct($file)
    {
        ...
        if (empty($file) OR empty($info))
        {
            ...
            throw new Core_Exception('Not an image or invalid image: :file',
    ...
    public function save($file = NULL, $quality = 100)
    {
        ...
        if (is_file($file))
        {
            if ( ! is_writable($file))
            {
                throw new Core_Exception('File must be writable: :file',
                    array(':file' => Debug::path($file)));
            }
        }
        else
        {
            ...
            {
                throw new Core_Exception('Directory must be writable: :directory',
